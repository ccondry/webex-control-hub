...
// list
describe('client.calling.number.list()', function () {
  it('list up to the first 100 Calling Numbers', function (done) {
    client.calling.number.list()
    .then(response => {
...
// listAll
describe('client.calling.number.listAll()', function () {
  it('list all Calling Numbers', function (done) {
  client.calling.number.listAll()
    .then(response => {
      console.log('found', response.length)
      // console.log(response)
      done()
