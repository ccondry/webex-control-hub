...
module.exports = class Skill {
  ...
  /**
  * Gets full list of skills
  * @return {Promise} the fetch promise, which resolves to skills JSON array when
  * successful
  */
  async listAll () {
    try {
